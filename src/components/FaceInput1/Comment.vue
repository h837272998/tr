...
<!--&lt;!&ndash;          <img src="../assets/img/heading.jpg" />&ndash;&gt;-->
<!--          <span class="comments-list-item-username">xx</span>-->
<!--        </div>-->
<!--        <div class="comments-list-item-content" v-html="content"></div>-->
<!--      </div>-->
<!--    </div>-->
...
export default {
  ...
  methods: {
    saveComment() {
      const newContent = this.content.replace(/:.*?:/g, this.emoji) // 替换":"符号包含的字符串,通过emoji方法生成表情<span></span>
