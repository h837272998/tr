    ...
    <el-form ref="postForm" :model="postForm" :rules="rules" class="form-container">
      ...
      <div class="createPost-main-container">
        ...
        <el-form-item label="归属:" label-width="45px" prop="subvalue" @click="checkOption">
          <el-cascader v-model="postForm.subValue" :options="subOptions" style="width: 50%" :props="subProps" filterable
                       clearable />
    ...
    <el-dialog title="添加课程" :visible.sync="dialogVisible">
      <el-form ref="dialogDate" :model="add" :rules="dialogRules">
        <el-form-item label="请选择" label-width="80px">
          <el-cascader v-model="add.sub" :options="add.subOptions" style="width: 50%" :props="add.subProps"
                       placeholder="请先选择专业"
                       filterable
                       clearable />
        ...
        <template v-if="add.sub.length === 2">
          ...
          <el-form-item label="课程名" label-width="80px" prop="courseName">
            <el-input placeholder="请输入课程名" v-model="add.courseName"></el-input>
          </el-form-item>
...
export default {
  ...
  created() {
    ...
    this.postForm.shareZone = this.$store.getters.userType
  },
  destroyed() {
    Bus.$off('fileAdded')
    Bus.$off('fileSuccess')
